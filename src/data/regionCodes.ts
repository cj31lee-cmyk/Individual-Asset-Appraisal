// 법정동코드 (LAWD_CD, 시·군·구 단위 5자리)
// 출처: 행정안전부 행정표준코드관리시스템 (www.code.go.kr) 기준 정리.
// 정확도 ~95% 추정 — 잘못된 코드 발견 시 즉시 수정.
//
// 주요 최근 변경:
// - 2018.07: 인천 남구 → 미추홀구 (코드 28177 유지)
// - 2023.06: 강원도(42) → 강원특별자치도(51)
// - 2023.07: 군위군 경북(47720) → 대구(27720) 편입
// - 2024.01: 전라북도(45) → 전북특별자치도 (코드 45 유지로 보임 — 검증 필요)
...
export const SIGUNGU_BY_SIDO: Record<SidoName, SigunguEntry[]> = {
  서울특별시: [
    { name: "종로구", code: "11110" },
    { name: "중구", code: "11140" },
    { name: "용산구", code: "11170" },
  ...
  대구광역시: [
    ...
    { name: "달서구", code: "27290" },
    { name: "달성군", code: "27710" },
    { name: "군위군", code: "27720" }, // 2023.07 경북에서 편입
  ],
  인천광역시: [
    { name: "중구", code: "28110" },
    { name: "동구", code: "28140" },
  ...
  전북특별자치도: [
    // 2024.01 전북특별자치도 전환 시 코드 45 → 52로 변경됨 (실측 검증)
