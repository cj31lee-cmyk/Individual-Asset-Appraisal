...
import { Landmark, Sparkles, ChevronLeft, ChevronRight, FileSpreadsheet } from "lucide-react";
...
export function NPLAnalysisTool() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Case navigation bar */}
      {totalCases > 1 && (
        <div className="border-b border-border bg-muted/30 sticky top-[73px] z-10">
